...
SHOT_REQUIREMENTS = {
    1: "Shot 1 - LIFESTYLE BATHROOM (FRONT-LEANING VIEW): Strictly preserve the original bathmat design, shape, tufting texture, color, and motif. Absolute design fidelity required. Keep the bathmat laid horizontally in frame. Compose the shot from a slightly front-facing perspective at roughly a 30-degree viewing angle, while still showing tasteful bathroom background context. Place the mat flat on a clean light-toned bathroom floor in front of a freestanding bathtub or bath area. Include minimal, tasteful bathroom props such as a wicker basket with rolled white towels, a small potted plant, and neutral slippers beside the mat — no prop may overlap or obscure the mat. Use warm natural lighting. Maintain premium editorial home décor photography quality. FRAMING ENFORCEMENT: all 4 corners must be visible; maintain 8-12% empty floor margin on every side; target bathmat coverage 65-80% of frame; if any edge risks crop, zoom out / move camera back until fully visible; prioritize full-product visibility over cinematic composition.",
    2: "Shot 2 - STYLED TOP VIEW (HIGH ANGLE): Strictly preserve the original bathmat design, shape, tufting texture, color, and motif. Absolute design fidelity required. Keep the bathmat laid horizontally in frame. Compose the shot from a high-angle near-top view around 60 degrees, with the environment still visible as soft background context. Place the mat flat on a clean light-toned bathroom floor in front of a freestanding bathtub or bath area. Add one or two props for variety, for example a folded towel and soap dish or a trailing green plant, while ensuring no prop overlaps the mat. Use soft, even premium lighting and maintain clean editorial styling. FRAMING ENFORCEMENT: all 4 corners must be visible; maintain 8-12% empty floor margin on every side; target bathmat coverage 65-80% of frame; if any edge risks crop, zoom out / move camera back until fully visible; prioritize full-product visibility over cinematic composition.",
    3: "Shot 3 - FLAT LAY STYLED: Strictly preserve the original bathmat design, shape, tufting texture, color, and motif. Absolute design fidelity required. Create a top-down flat lay shot of the mat laid on a light-toned wooden or hexagonal tile floor. Surround the mat with minimal complementary lifestyle props such as a folded white towel, a small soap dish, and a green trailing plant — all placed around the mat without overlapping it. Use soft even lighting with no harsh shadows. Maintain clean, premium home décor editorial photography quality. FRAMING ENFORCEMENT: all 4 corners must be visible; maintain 8-12% empty floor margin on every side; target bathmat coverage 65-80% of frame; if any edge risks crop, zoom out / move camera back until fully visible; prioritize full-product visibility over cinematic composition.",
    4: "Shot 4 - LOW ANGLE DEPTH HERO: Strictly preserve the original bathmat design, shape, tufting texture, color, and motif. Absolute design fidelity required. Place the bathmat flat on a premium bathroom floor (stone, terrazzo, or matte tile). Compose from a low angle around 10-20 degrees to create depth and dimension, with the mat in sharp foreground focus and background softly blurred. Include a freestanding bathtub edge or vanity in the background, softly out of focus. Use directional natural light (window light) to create soft shadows and highlight pile depth. Keep props minimal and distant (e.g., a towel or plant in background only, not near edges). Maintain a premium editorial, slightly cinematic feel. FRAMING ENFORCEMENT: all 4 corners must be visible; maintain 8-12% empty floor margin on every side; target bathmat coverage 65-80% of frame; if any edge risks crop, zoom out / move camera back until fully visible; prioritize full-product visibility over cinematic composition.",
    5: "Shot 5 - MACRO TEXTURE DETAIL: Strictly preserve the original bathmat design, shape, tufting texture, color, and motif. Absolute design fidelity required. Create a texture-emphasis composition while still showing the entire bathmat fully inside frame; one section may appear closer to camera to emphasize tufted pile height, softness, and fiber detail. Use a shallow depth of field with front area crisp and background gently softened. Lighting should be soft directional light to enhance texture without harsh contrast. No props overlapping; optional very minimal blurred background context only. Maintain hyper-realistic material fidelity and premium textile photography quality. FRAMING ENFORCEMENT: all 4 corners must be visible; maintain 8-12% empty floor margin on every side; target bathmat coverage 65-80% of frame; if any edge risks crop, zoom out / move camera back until fully visible; prioritize full-product visibility over cinematic composition.",
    6: "Shot 6 - IN-USE FOOT INTERACTION: Strictly preserve the original bathmat design, shape, tufting texture, color, and motif. Absolute design fidelity required. Place the mat flat on a clean bathroom floor beside a bathtub or shower area. Include a single human element: one bare foot gently stepping onto the mat from edge or corner, showing softness and scale. Ensure the foot does not obscure key design elements. Keep the rest of the scene minimal with soft lifestyle context (e.g., towel on tub, subtle plant). Use natural daylight with soft shadows. Maintain premium, hygienic, aspirational bathroom styling. FRAMING ENFORCEMENT: all 4 corners must be visible; maintain 8-12% empty floor margin on every side; target bathmat coverage 65-80% of frame; if any edge risks crop, zoom out / move camera back until fully visible; prioritize full-product visibility over cinematic composition.",
    ...
    8: "Shot 8 - MINIMAL SPA SETTING: Strictly preserve the original bathmat design, shape, tufting texture, color, and motif. Absolute design fidelity required. Place the mat in a serene, spa-like bathroom setting with a very clean, minimal composition. Use neutral tones (warm whites, beige, soft stone textures). Include 1-2 refined props such as rolled white towels, a candle, or a small ceramic vase—placed far from the mat with no overlap. Emphasize negative space and calm composition. Use soft diffused lighting with almost no harsh shadows. Ensure the color of the product stays same as in the reference image, and is not affected by the lighting."
}
ACTIVE_SHOT_IDS = (7, 8)

const SBASE = "https://zscdsnqiktvavouovbuh.supabase.co/storage/v1/object/public/contentpro-images/landing-assets";
const heroImg = `${SBASE}/hero-product.jpg`;
const fashionImg = `${SBASE}/transform-fashion.jpg`;
const jewelImg = `${SBASE}/transform-jewellery.jpg`;
const realestateImg = `${SBASE}/transform-homefurnishing.jpg`;
const beforeJewel = `${SBASE}/before-jewellery.jpg`;
const beforeFashion = `${SBASE}/before-fashion.jpg`;
const beforeRealestate = `${SBASE}/before-homefurnishing.jpg`;
const csEarringsBefore = `${SBASE}/before-earrings.jpg`;
const csEarringsAfter = `${SBASE}/transform-earrings.jpg`;
const csCushionBefore = `${SBASE}/before-cushion.jpg`;
const csCushionAfter = `${SBASE}/transform-cushion.jpg`;
const csFootwearBefore = `${SBASE}/before-footwear.jpg`;
const csFootwearAfter = `${SBASE}/transform-footwear.jpg`;
const sareeBefore = `${SBASE}/before-saree.jpg`;
const sareeAfter = `${SBASE}/after-saree.jpg`;
const visualCampaign = `${SBASE}/visual-campaign.jpg`;
const visualFlatlay = `${SBASE}/visual-flatlay.jpg`;
const visualTradeshow = `${SBASE}/visual-tradeshow.jpg`;
const visualPortrait = `${SBASE}/visual-portrait.jpg`;
const catFurnishing = `${SBASE}/cat-furnishing.jpg`;
const catWallart = `${SBASE}/cat-wallart.jpg`;
const catApparel = `${SBASE}/cat-apparel.jpg`;
const catJewelry = `${SBASE}/cat-jewelry.jpg`;
const apparelHero = `${SBASE}/apparel-hero.jpg`;
const apparelLifestyle = `${SBASE}/apparel-lifestyle.jpg`;
const apparelStory = `${SBASE}/apparel-story.jpg`;
const apparelDetail = `${SBASE}/apparel-detail.jpg`;
